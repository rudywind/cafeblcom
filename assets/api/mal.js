			...
			$.ajax({
				...
				success: function(p) {
					...
					var html = '<div class="comic_anime">' +
						...
						//END SYNOPSIS
						//TITLE INFORMATION
						'<div class="detail-info mt-2"><h2 class="head2">Infomation</h2><ul><li><strong>Title: </strong>' + title + '</li><li><strong>English Title: </strong>' + (title_english || "-") + '</li><li><strong>Japanese Title: </strong>' + (title_japanese || "-") + '</li><li><strong>Type: </strong>' + (type || "-") + '</li><li><strong>Genres: </strong>' + genres + '</li><li><strong>Themes: </strong>' + themes + '</li><li><strong>Demographics: </strong>' + demographics + '</li><li><strong>Source: </strong>' + (source || "-") + '</li><li><strong>No. Episodes: </strong>' + (episodes || "-") + '</li><li><strong>Season: </strong>' + (season || "-") + '</li><li><strong>Released Year: </strong>' + (year || "-") + '</li><li><strong>Aired: </strong>' + (aired || "-") + '</li><li><strong>Broadcast: </strong>' + (broadcast || "-") + '</li></ul><h2 class="head2">Production</h2><ul><li><strong>Licensors: </strong>' + (licensors || "-") + '</li><li><strong>Studios: </strong>' + (studios || "-") + '</li></ul></div>' +
